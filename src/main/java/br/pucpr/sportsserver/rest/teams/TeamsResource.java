...
public class TeamsResource {
    ...
    @SecurityRequirement(name = "AuthServer")
    @RolesAllowed({"USER"})
    public List<TeamResponse> searchMeJoinRequests(@Valid @PathVariable("name") String name) {
        var user = (User) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        return service.searchUserJoinRequests(user.getId(),name,false);
    }
    ...
    @SecurityRequirement(name = "AuthServer")
    @RolesAllowed({"USER"})
    public List<TeamResponse> searchMeJoinInvites(@Valid @PathVariable("name") String name) {
        var user = (User) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        return service.searchUserJoinRequests(user.getId(),name,true);
    }
